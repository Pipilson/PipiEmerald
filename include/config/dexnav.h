...
#define DN_VAR_SPECIES                VAR_SPECIES // Registered DexNav species
...
#define HIDDEN_MON_STEP_COUNT       100  // Look for hidden pokemon every x steps -- 100
#define HIDDEN_MON_SEARCH_RATE      25   // x% chance of finding hidden pokemon every x steps -- 25
#define HIDDEN_MON_PROBABILTY       15   // x% chance of finding hidden mon compared to regular encounter data -- 15
