...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_TESTE_1 // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_TESTE_2 // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_TESTE_3 // Allow player to find hidden mons
#define DN_VAR_SPECIES                FLAG_TESTE_4 // Registered DexNav species
#define DN_VAR_STEP_COUNTER           FLAG_TESTE_5 // Steps for finding hidden pokemon
